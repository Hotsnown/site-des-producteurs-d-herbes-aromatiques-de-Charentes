    ...
    <Table bordered condensed hover responsive>
      <thead>
        <tr>
          ...
          <th>Producteur</th>
          <th>Date de l'ajout du stock</th>
...
class IssueList extends React.Component {
  ...
  loadData() {
    ...
    .then(data => {
      ...
      this.props.showError(`Erreur dans l'extraction des données du serveur : ${err}`);
    });
  }

  deleteIssue(id) {
    fetch(`/api/issues/${id}`, { method: 'DELETE' }).then(response => {
      if (!response.ok) this.props.showError('La suppression du stock a échoué');
      else this.loadData();
    });
  }
